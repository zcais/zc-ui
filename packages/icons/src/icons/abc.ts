...
registerIcon('abc', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconAbc'

export const ZcIconAbc = withInstall(_comp, 'ZcIconAbc')
