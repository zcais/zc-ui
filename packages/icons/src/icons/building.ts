 ...
 * Source: icons/outline/building.svg
 */
...
registerIcon('building', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBuilding'

export const ZcIconBuilding = withInstall(_comp, 'ZcIconBuilding')
