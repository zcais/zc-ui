 ...
 * Source: icons/outline/pinned-off.svg
 */
...
registerIcon('pinned-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconPinnedOff'

export const ZcIconPinnedOff = withInstall(_comp, 'ZcIconPinnedOff')
