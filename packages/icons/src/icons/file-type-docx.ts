 ...
 * Source: icons/outline/file-type-docx.svg
 */
...
registerIcon('file-type-docx', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconFileTypeDocx'

export const ZcIconFileTypeDocx = withInstall(_comp, 'ZcIconFileTypeDocx')
