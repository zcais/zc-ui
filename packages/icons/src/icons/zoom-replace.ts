 ...
 * Source: icons/outline/zoom-replace.svg
 */
...
registerIcon('zoom-replace', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconZoomReplace'

export const ZcIconZoomReplace = withInstall(_comp, 'ZcIconZoomReplace')
