 ...
 * Source: icons/outline/laurel-wreath-2.svg
 */
...
registerIcon('laurel-wreath-2', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconLaurelWreath2'

export const ZcIconLaurelWreath2 = withInstall(_comp, 'ZcIconLaurelWreath2')
