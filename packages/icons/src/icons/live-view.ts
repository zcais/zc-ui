 ...
 * Source: icons/outline/live-view.svg
 */
...
registerIcon('live-view', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconLiveView'

export const ZcIconLiveView = withInstall(_comp, 'ZcIconLiveView')
