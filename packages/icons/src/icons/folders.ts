 ...
 * Source: icons/outline/folders.svg
 */
...
registerIcon('folders', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconFolders'

export const ZcIconFolders = withInstall(_comp, 'ZcIconFolders')
