 ...
 * Source: icons/outline/message-off.svg
 */
...
registerIcon('message-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconMessageOff'

export const ZcIconMessageOff = withInstall(_comp, 'ZcIconMessageOff')
