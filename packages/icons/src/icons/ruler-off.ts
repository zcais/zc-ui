 ...
 * Source: icons/outline/ruler-off.svg
 */
...
registerIcon('ruler-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconRulerOff'

export const ZcIconRulerOff = withInstall(_comp, 'ZcIconRulerOff')
