/**
 * ZcIconDeviceImacQuestion
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/device-imac-question.svg
 */
...
registerIcon('device-imac-question', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconDeviceImacQuestion'

export const ZcIconDeviceImacQuestion = withInstall(_comp, 'ZcIconDeviceImacQuestion')
