 ...
 * Source: icons/outline/dental.svg
 */
...
registerIcon('dental', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconDental'

export const ZcIconDental = withInstall(_comp, 'ZcIconDental')
