 ...
 * Source: icons/outline/camera-check.svg
 */
...
registerIcon('camera-check', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCameraCheck'

export const ZcIconCameraCheck = withInstall(_comp, 'ZcIconCameraCheck')
