 ...
 * Source: icons/outline/camera-code.svg
 */
...
registerIcon('camera-code', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCameraCode'

export const ZcIconCameraCode = withInstall(_comp, 'ZcIconCameraCode')
