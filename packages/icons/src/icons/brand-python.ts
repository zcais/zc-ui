 ...
 * Source: icons/outline/brand-python.svg
 */
...
registerIcon('brand-python', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBrandPython'

export const ZcIconBrandPython = withInstall(_comp, 'ZcIconBrandPython')
