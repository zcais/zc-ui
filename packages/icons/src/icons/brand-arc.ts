 ...
 * Source: icons/outline/brand-arc.svg
 */
...
registerIcon('brand-arc', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBrandArc'

export const ZcIconBrandArc = withInstall(_comp, 'ZcIconBrandArc')
