 ...
 * Source: icons/outline/car-fan-3.svg
 */
...
registerIcon('car-fan-3', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCarFan3'

export const ZcIconCarFan3 = withInstall(_comp, 'ZcIconCarFan3')
