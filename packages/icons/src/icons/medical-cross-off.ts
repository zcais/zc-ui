/**
 * ZcIconMedicalCrossOff
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/medical-cross-off.svg
 */
...
registerIcon('medical-cross-off', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconMedicalCrossOff'

export const ZcIconMedicalCrossOff = withInstall(_comp, 'ZcIconMedicalCrossOff')
