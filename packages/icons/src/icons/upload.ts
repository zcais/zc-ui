...
registerIcon('upload', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconUpload'

export const ZcIconUpload = withInstall(_comp, 'ZcIconUpload')
