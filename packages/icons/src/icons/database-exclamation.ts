/**
 * ZcIconDatabaseExclamation
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/database-exclamation.svg
 */
...
registerIcon('database-exclamation', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconDatabaseExclamation'

export const ZcIconDatabaseExclamation = withInstall(_comp, 'ZcIconDatabaseExclamation')
