 ...
 * Source: icons/outline/shadow-off.svg
 */
...
registerIcon('shadow-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconShadowOff'

export const ZcIconShadowOff = withInstall(_comp, 'ZcIconShadowOff')
