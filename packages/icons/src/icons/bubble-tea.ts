 ...
 * Source: icons/outline/bubble-tea.svg
 */
...
registerIcon('bubble-tea', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBubbleTea'

export const ZcIconBubbleTea = withInstall(_comp, 'ZcIconBubbleTea')
