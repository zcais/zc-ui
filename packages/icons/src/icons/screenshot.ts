 ...
 * Source: icons/outline/screenshot.svg
 */
...
registerIcon('screenshot', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconScreenshot'

export const ZcIconScreenshot = withInstall(_comp, 'ZcIconScreenshot')
