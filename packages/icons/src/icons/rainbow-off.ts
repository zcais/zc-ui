 ...
 * Source: icons/outline/rainbow-off.svg
 */
...
registerIcon('rainbow-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconRainbowOff'

export const ZcIconRainbowOff = withInstall(_comp, 'ZcIconRainbowOff')
