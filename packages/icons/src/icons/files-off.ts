 ...
 * Source: icons/outline/files-off.svg
 */
...
registerIcon('files-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconFilesOff'

export const ZcIconFilesOff = withInstall(_comp, 'ZcIconFilesOff')
