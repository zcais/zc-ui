 ...
 * Source: icons/outline/camera.svg
 */
...
registerIcon('camera', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCamera'

export const ZcIconCamera = withInstall(_comp, 'ZcIconCamera')
