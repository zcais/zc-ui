...
registerIcon('news', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconNews'

export const ZcIconNews = withInstall(_comp, 'ZcIconNews')
