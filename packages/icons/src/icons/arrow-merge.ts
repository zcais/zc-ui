 ...
 * Source: icons/outline/arrow-merge.svg
 */
...
registerIcon('arrow-merge', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconArrowMerge'

export const ZcIconArrowMerge = withInstall(_comp, 'ZcIconArrowMerge')
