/**
 * ZcIconMessageCirclePause
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/message-circle-pause.svg
 */
...
registerIcon('message-circle-pause', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconMessageCirclePause'

export const ZcIconMessageCirclePause = withInstall(_comp, 'ZcIconMessageCirclePause')
