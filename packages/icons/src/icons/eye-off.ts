 ...
 * Source: icons/outline/eye-off.svg
 */
...
registerIcon('eye-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconEyeOff'

export const ZcIconEyeOff = withInstall(_comp, 'ZcIconEyeOff')
