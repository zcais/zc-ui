 ...
 * Source: icons/outline/news-off.svg
 */
...
registerIcon('news-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconNewsOff'

export const ZcIconNewsOff = withInstall(_comp, 'ZcIconNewsOff')
