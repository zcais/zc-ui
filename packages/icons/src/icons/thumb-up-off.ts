 ...
 * Source: icons/outline/thumb-up-off.svg
 */
...
registerIcon('thumb-up-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconThumbUpOff'

export const ZcIconThumbUpOff = withInstall(_comp, 'ZcIconThumbUpOff')
