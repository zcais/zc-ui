...
registerIcon('gift', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconGift'

export const ZcIconGift = withInstall(_comp, 'ZcIconGift')
