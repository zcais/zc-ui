 ...
 * Source: icons/outline/devices-dollar.svg
 */
...
registerIcon('devices-dollar', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconDevicesDollar'

export const ZcIconDevicesDollar = withInstall(_comp, 'ZcIconDevicesDollar')
