 ...
 * Source: icons/outline/photo-check.svg
 */
...
registerIcon('photo-check', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconPhotoCheck'

export const ZcIconPhotoCheck = withInstall(_comp, 'ZcIconPhotoCheck')
