 ...
 * Source: icons/outline/cloud-x.svg
 */
...
registerIcon('cloud-x', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCloudX'

export const ZcIconCloudX = withInstall(_comp, 'ZcIconCloudX')
