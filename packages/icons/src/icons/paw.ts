...
registerIcon('paw', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconPaw'

export const ZcIconPaw = withInstall(_comp, 'ZcIconPaw')
