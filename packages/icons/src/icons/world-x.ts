 ...
 * Source: icons/outline/world-x.svg
 */
...
registerIcon('world-x', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconWorldX'

export const ZcIconWorldX = withInstall(_comp, 'ZcIconWorldX')
