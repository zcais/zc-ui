 ...
 * Source: icons/outline/home-dollar.svg
 */
...
registerIcon('home-dollar', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconHomeDollar'

export const ZcIconHomeDollar = withInstall(_comp, 'ZcIconHomeDollar')
