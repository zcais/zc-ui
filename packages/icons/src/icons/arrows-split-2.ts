 ...
 * Source: icons/outline/arrows-split-2.svg
 */
...
registerIcon('arrows-split-2', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconArrowsSplit2'

export const ZcIconArrowsSplit2 = withInstall(_comp, 'ZcIconArrowsSplit2')
