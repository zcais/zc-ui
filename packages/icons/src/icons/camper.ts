 ...
 * Source: icons/outline/camper.svg
 */
...
registerIcon('camper', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCamper'

export const ZcIconCamper = withInstall(_comp, 'ZcIconCamper')
