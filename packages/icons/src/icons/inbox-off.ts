 ...
 * Source: icons/outline/inbox-off.svg
 */
...
registerIcon('inbox-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconInboxOff'

export const ZcIconInboxOff = withInstall(_comp, 'ZcIconInboxOff')
