...
registerIcon('h-3', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconH3'

export const ZcIconH3 = withInstall(_comp, 'ZcIconH3')
