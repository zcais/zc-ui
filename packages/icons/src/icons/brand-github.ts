 ...
 * Source: icons/outline/brand-github.svg
 */
...
registerIcon('brand-github', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBrandGithub'

export const ZcIconBrandGithub = withInstall(_comp, 'ZcIconBrandGithub')
