 ...
 * Source: icons/outline/list-details.svg
 */
...
registerIcon('list-details', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconListDetails'

export const ZcIconListDetails = withInstall(_comp, 'ZcIconListDetails')
