 ...
 * Source: icons/outline/message-cog.svg
 */
...
registerIcon('message-cog', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconMessageCog'

export const ZcIconMessageCog = withInstall(_comp, 'ZcIconMessageCog')
