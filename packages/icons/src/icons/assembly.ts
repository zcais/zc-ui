 ...
 * Source: icons/outline/assembly.svg
 */
...
registerIcon('assembly', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconAssembly'

export const ZcIconAssembly = withInstall(_comp, 'ZcIconAssembly')
