...
registerIcon('wifi', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconWifi'

export const ZcIconWifi = withInstall(_comp, 'ZcIconWifi')
