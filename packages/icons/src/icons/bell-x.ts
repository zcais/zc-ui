 ...
 * Source: icons/outline/bell-x.svg
 */
...
registerIcon('bell-x', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBellX'

export const ZcIconBellX = withInstall(_comp, 'ZcIconBellX')
