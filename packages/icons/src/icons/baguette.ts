 ...
 * Source: icons/outline/baguette.svg
 */
...
registerIcon('baguette', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBaguette'

export const ZcIconBaguette = withInstall(_comp, 'ZcIconBaguette')
