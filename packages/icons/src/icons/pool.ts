...
registerIcon('pool', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconPool'

export const ZcIconPool = withInstall(_comp, 'ZcIconPool')
