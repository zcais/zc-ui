 ...
 * Source: icons/outline/ghost.svg
 */
...
registerIcon('ghost', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconGhost'

export const ZcIconGhost = withInstall(_comp, 'ZcIconGhost')
