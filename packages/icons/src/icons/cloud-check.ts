 ...
 * Source: icons/outline/cloud-check.svg
 */
...
registerIcon('cloud-check', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCloudCheck'

export const ZcIconCloudCheck = withInstall(_comp, 'ZcIconCloudCheck')
