 ...
 * Source: icons/outline/mood-check.svg
 */
...
registerIcon('mood-check', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconMoodCheck'

export const ZcIconMoodCheck = withInstall(_comp, 'ZcIconMoodCheck')
