 ...
 * Source: icons/outline/radio-off.svg
 */
...
registerIcon('radio-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconRadioOff'

export const ZcIconRadioOff = withInstall(_comp, 'ZcIconRadioOff')
