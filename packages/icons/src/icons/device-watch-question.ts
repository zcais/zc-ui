/**
 * ZcIconDeviceWatchQuestion
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/device-watch-question.svg
 */
...
registerIcon('device-watch-question', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconDeviceWatchQuestion'

export const ZcIconDeviceWatchQuestion = withInstall(_comp, 'ZcIconDeviceWatchQuestion')
