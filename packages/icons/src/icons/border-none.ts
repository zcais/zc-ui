 ...
 * Source: icons/outline/border-none.svg
 */
...
registerIcon('border-none', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBorderNone'

export const ZcIconBorderNone = withInstall(_comp, 'ZcIconBorderNone')
