 ...
 * Source: icons/outline/brand-yarn.svg
 */
...
registerIcon('brand-yarn', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBrandYarn'

export const ZcIconBrandYarn = withInstall(_comp, 'ZcIconBrandYarn')
