/**
 * ZcIconHandLittleFinger
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/hand-little-finger.svg
 */
...
registerIcon('hand-little-finger', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconHandLittleFinger'

export const ZcIconHandLittleFinger = withInstall(_comp, 'ZcIconHandLittleFinger')
