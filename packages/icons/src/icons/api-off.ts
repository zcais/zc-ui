 ...
 * Source: icons/outline/api-off.svg
 */
...
registerIcon('api-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconApiOff'

export const ZcIconApiOff = withInstall(_comp, 'ZcIconApiOff')
