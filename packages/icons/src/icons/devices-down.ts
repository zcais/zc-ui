 ...
 * Source: icons/outline/devices-down.svg
 */
...
registerIcon('devices-down', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconDevicesDown'

export const ZcIconDevicesDown = withInstall(_comp, 'ZcIconDevicesDown')
