 ...
 * Source: icons/outline/camera-dollar.svg
 */
...
registerIcon('camera-dollar', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCameraDollar'

export const ZcIconCameraDollar = withInstall(_comp, 'ZcIconCameraDollar')
