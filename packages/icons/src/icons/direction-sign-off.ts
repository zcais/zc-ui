/**
 * ZcIconDirectionSignOff
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/direction-sign-off.svg
 */
...
registerIcon('direction-sign-off', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconDirectionSignOff'

export const ZcIconDirectionSignOff = withInstall(_comp, 'ZcIconDirectionSignOff')
