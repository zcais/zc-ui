 ...
 * Source: icons/outline/focus-auto.svg
 */
...
registerIcon('focus-auto', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconFocusAuto'

export const ZcIconFocusAuto = withInstall(_comp, 'ZcIconFocusAuto')
