/**
 * ZcIconCertificateOff
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/certificate-off.svg
 */
...
registerIcon('certificate-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCertificateOff'

export const ZcIconCertificateOff = withInstall(_comp, 'ZcIconCertificateOff')
