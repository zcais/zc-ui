 ...
 * Source: icons/outline/world-share.svg
 */
...
registerIcon('world-share', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconWorldShare'

export const ZcIconWorldShare = withInstall(_comp, 'ZcIconWorldShare')
