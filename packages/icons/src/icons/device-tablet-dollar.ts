/**
 * ZcIconDeviceTabletDollar
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/device-tablet-dollar.svg
 */
...
registerIcon('device-tablet-dollar', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconDeviceTabletDollar'

export const ZcIconDeviceTabletDollar = withInstall(_comp, 'ZcIconDeviceTabletDollar')
