 ...
 * Source: icons/outline/eye-table.svg
 */
...
registerIcon('eye-table', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconEyeTable'

export const ZcIconEyeTable = withInstall(_comp, 'ZcIconEyeTable')
