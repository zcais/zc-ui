...
registerIcon('h-5', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconH5'

export const ZcIconH5 = withInstall(_comp, 'ZcIconH5')
