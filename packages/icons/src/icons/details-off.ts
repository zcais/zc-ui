 ...
 * Source: icons/outline/details-off.svg
 */
...
registerIcon('details-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconDetailsOff'

export const ZcIconDetailsOff = withInstall(_comp, 'ZcIconDetailsOff')
