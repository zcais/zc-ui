/**
 * ZcIconLayersDifference
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/layers-difference.svg
 */
...
registerIcon('layers-difference', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconLayersDifference'

export const ZcIconLayersDifference = withInstall(_comp, 'ZcIconLayersDifference')
