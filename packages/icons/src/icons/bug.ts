...
registerIcon('bug', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBug'

export const ZcIconBug = withInstall(_comp, 'ZcIconBug')
