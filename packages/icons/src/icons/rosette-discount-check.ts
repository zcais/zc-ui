/**
 * ZcIconRosetteDiscountCheck
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/rosette-discount-check.svg
 */
...
registerIcon('rosette-discount-check', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconRosetteDiscountCheck'

export const ZcIconRosetteDiscountCheck = withInstall(_comp, 'ZcIconRosetteDiscountCheck')
