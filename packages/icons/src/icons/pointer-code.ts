 ...
 * Source: icons/outline/pointer-code.svg
 */
...
registerIcon('pointer-code', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconPointerCode'

export const ZcIconPointerCode = withInstall(_comp, 'ZcIconPointerCode')
