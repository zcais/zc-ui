 ...
 * Source: icons/outline/users-group.svg
 */
...
registerIcon('users-group', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconUsersGroup'

export const ZcIconUsersGroup = withInstall(_comp, 'ZcIconUsersGroup')
