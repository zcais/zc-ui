 ...
 * Source: icons/outline/world-question.svg
 */
...
registerIcon('world-question', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconWorldQuestion'

export const ZcIconWorldQuestion = withInstall(_comp, 'ZcIconWorldQuestion')
