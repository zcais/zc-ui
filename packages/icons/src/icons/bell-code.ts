 ...
 * Source: icons/outline/bell-code.svg
 */
...
registerIcon('bell-code', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBellCode'

export const ZcIconBellCode = withInstall(_comp, 'ZcIconBellCode')
