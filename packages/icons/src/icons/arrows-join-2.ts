 ...
 * Source: icons/outline/arrows-join-2.svg
 */
...
registerIcon('arrows-join-2', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconArrowsJoin2'

export const ZcIconArrowsJoin2 = withInstall(_comp, 'ZcIconArrowsJoin2')
