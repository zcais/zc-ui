 ...
 * Source: icons/outline/hanger.svg
 */
...
registerIcon('hanger', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconHanger'

export const ZcIconHanger = withInstall(_comp, 'ZcIconHanger')
