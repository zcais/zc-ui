 ...
 * Source: icons/outline/currency-baht.svg
 */
...
registerIcon('currency-baht', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCurrencyBaht'

export const ZcIconCurrencyBaht = withInstall(_comp, 'ZcIconCurrencyBaht')
