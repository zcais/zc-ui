 ...
 * Source: icons/outline/wallet-off.svg
 */
...
registerIcon('wallet-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconWalletOff'

export const ZcIconWalletOff = withInstall(_comp, 'ZcIconWalletOff')
