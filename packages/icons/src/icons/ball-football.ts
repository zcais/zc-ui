 ...
 * Source: icons/outline/ball-football.svg
 */
...
registerIcon('ball-football', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBallFootball'

export const ZcIconBallFootball = withInstall(_comp, 'ZcIconBallFootball')
