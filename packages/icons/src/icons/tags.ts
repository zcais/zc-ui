...
registerIcon('tags', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconTags'

export const ZcIconTags = withInstall(_comp, 'ZcIconTags')
