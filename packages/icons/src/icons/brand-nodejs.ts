 ...
 * Source: icons/outline/brand-nodejs.svg
 */
...
registerIcon('brand-nodejs', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBrandNodejs'

export const ZcIconBrandNodejs = withInstall(_comp, 'ZcIconBrandNodejs')
