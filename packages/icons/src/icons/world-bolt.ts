 ...
 * Source: icons/outline/world-bolt.svg
 */
...
registerIcon('world-bolt', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconWorldBolt'

export const ZcIconWorldBolt = withInstall(_comp, 'ZcIconWorldBolt')
