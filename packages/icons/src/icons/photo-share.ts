 ...
 * Source: icons/outline/photo-share.svg
 */
...
registerIcon('photo-share', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconPhotoShare'

export const ZcIconPhotoShare = withInstall(_comp, 'ZcIconPhotoShare')
