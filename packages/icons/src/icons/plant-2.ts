 ...
 * Source: icons/outline/plant-2.svg
 */
...
registerIcon('plant-2', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconPlant2'

export const ZcIconPlant2 = withInstall(_comp, 'ZcIconPlant2')
