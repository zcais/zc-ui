 ...
 * Source: icons/outline/camera-pause.svg
 */
...
registerIcon('camera-pause', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCameraPause'

export const ZcIconCameraPause = withInstall(_comp, 'ZcIconCameraPause')
