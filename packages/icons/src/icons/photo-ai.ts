 ...
 * Source: icons/outline/photo-ai.svg
 */
...
registerIcon('photo-ai', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconPhotoAi'

export const ZcIconPhotoAi = withInstall(_comp, 'ZcIconPhotoAi')
