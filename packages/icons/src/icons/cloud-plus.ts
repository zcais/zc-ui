 ...
 * Source: icons/outline/cloud-plus.svg
 */
...
registerIcon('cloud-plus', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCloudPlus'

export const ZcIconCloudPlus = withInstall(_comp, 'ZcIconCloudPlus')
