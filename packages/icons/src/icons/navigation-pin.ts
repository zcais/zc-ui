 ...
 * Source: icons/outline/navigation-pin.svg
 */
...
registerIcon('navigation-pin', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconNavigationPin'

export const ZcIconNavigationPin = withInstall(_comp, 'ZcIconNavigationPin')
