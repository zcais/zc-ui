 ...
 * Source: icons/outline/photo-code.svg
 */
...
registerIcon('photo-code', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconPhotoCode'

export const ZcIconPhotoCode = withInstall(_comp, 'ZcIconPhotoCode')
