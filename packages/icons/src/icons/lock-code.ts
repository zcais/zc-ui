 ...
 * Source: icons/outline/lock-code.svg
 */
...
registerIcon('lock-code', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconLockCode'

export const ZcIconLockCode = withInstall(_comp, 'ZcIconLockCode')
