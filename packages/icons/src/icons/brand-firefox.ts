 ...
 * Source: icons/outline/brand-firefox.svg
 */
...
registerIcon('brand-firefox', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBrandFirefox'

export const ZcIconBrandFirefox = withInstall(_comp, 'ZcIconBrandFirefox')
