 ...
 * Source: icons/outline/mood-boy.svg
 */
...
registerIcon('mood-boy', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconMoodBoy'

export const ZcIconMoodBoy = withInstall(_comp, 'ZcIconMoodBoy')
