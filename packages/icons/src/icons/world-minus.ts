 ...
 * Source: icons/outline/world-minus.svg
 */
...
registerIcon('world-minus', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconWorldMinus'

export const ZcIconWorldMinus = withInstall(_comp, 'ZcIconWorldMinus')
