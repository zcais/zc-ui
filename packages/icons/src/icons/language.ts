 ...
 * Source: icons/outline/language.svg
 */
...
registerIcon('language', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconLanguage'

export const ZcIconLanguage = withInstall(_comp, 'ZcIconLanguage')
