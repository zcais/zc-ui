 ...
 * Source: icons/outline/webhook.svg
 */
...
registerIcon('webhook', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconWebhook'

export const ZcIconWebhook = withInstall(_comp, 'ZcIconWebhook')
