 ...
 * Source: icons/outline/send-off.svg
 */
...
registerIcon('send-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconSendOff'

export const ZcIconSendOff = withInstall(_comp, 'ZcIconSendOff')
