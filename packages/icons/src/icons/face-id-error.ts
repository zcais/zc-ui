 ...
 * Source: icons/outline/face-id-error.svg
 */
...
registerIcon('face-id-error', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconFaceIdError'

export const ZcIconFaceIdError = withInstall(_comp, 'ZcIconFaceIdError')
