 ...
 * Source: icons/outline/brand-nord-vpn.svg
 */
...
registerIcon('brand-nord-vpn', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBrandNordVpn'

export const ZcIconBrandNordVpn = withInstall(_comp, 'ZcIconBrandNordVpn')
