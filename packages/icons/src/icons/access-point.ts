 ...
 * Source: icons/outline/access-point.svg
 */
...
registerIcon('access-point', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconAccessPoint'

export const ZcIconAccessPoint = withInstall(_comp, 'ZcIconAccessPoint')
