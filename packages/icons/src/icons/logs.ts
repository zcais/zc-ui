...
registerIcon('logs', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconLogs'

export const ZcIconLogs = withInstall(_comp, 'ZcIconLogs')
