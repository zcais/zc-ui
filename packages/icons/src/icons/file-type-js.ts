 ...
 * Source: icons/outline/file-type-js.svg
 */
...
registerIcon('file-type-js', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconFileTypeJs'

export const ZcIconFileTypeJs = withInstall(_comp, 'ZcIconFileTypeJs')
