 ...
 * Source: icons/outline/bell-ringing.svg
 */
...
registerIcon('bell-ringing', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBellRinging'

export const ZcIconBellRinging = withInstall(_comp, 'ZcIconBellRinging')
