 ...
 * Source: icons/outline/barbell.svg
 */
...
registerIcon('barbell', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBarbell'

export const ZcIconBarbell = withInstall(_comp, 'ZcIconBarbell')
