 ...
 * Source: icons/outline/droplet-code.svg
 */
...
registerIcon('droplet-code', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconDropletCode'

export const ZcIconDropletCode = withInstall(_comp, 'ZcIconDropletCode')
