 ...
 * Source: icons/outline/ticket.svg
 */
...
registerIcon('ticket', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconTicket'

export const ZcIconTicket = withInstall(_comp, 'ZcIconTicket')
