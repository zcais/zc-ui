/**
 * ZcIconWashTemperature2
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/wash-temperature-2.svg
 */
...
registerIcon('wash-temperature-2', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconWashTemperature2'

export const ZcIconWashTemperature2 = withInstall(_comp, 'ZcIconWashTemperature2')
