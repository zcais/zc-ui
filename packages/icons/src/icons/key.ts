...
registerIcon('key', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconKey'

export const ZcIconKey = withInstall(_comp, 'ZcIconKey')
