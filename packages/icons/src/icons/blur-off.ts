 ...
 * Source: icons/outline/blur-off.svg
 */
...
registerIcon('blur-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBlurOff'

export const ZcIconBlurOff = withInstall(_comp, 'ZcIconBlurOff')
