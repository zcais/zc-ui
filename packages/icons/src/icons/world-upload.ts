 ...
 * Source: icons/outline/world-upload.svg
 */
...
registerIcon('world-upload', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconWorldUpload'

export const ZcIconWorldUpload = withInstall(_comp, 'ZcIconWorldUpload')
