 ...
 * Source: icons/outline/tools.svg
 */
...
registerIcon('tools', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconTools'

export const ZcIconTools = withInstall(_comp, 'ZcIconTools')
