 ...
 * Source: icons/outline/home-off.svg
 */
...
registerIcon('home-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconHomeOff'

export const ZcIconHomeOff = withInstall(_comp, 'ZcIconHomeOff')
