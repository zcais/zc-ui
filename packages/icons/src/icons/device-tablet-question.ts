/**
 * ZcIconDeviceTabletQuestion
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/device-tablet-question.svg
 */
...
registerIcon('device-tablet-question', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconDeviceTabletQuestion'

export const ZcIconDeviceTabletQuestion = withInstall(_comp, 'ZcIconDeviceTabletQuestion')
