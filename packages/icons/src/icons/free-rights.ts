 ...
 * Source: icons/outline/free-rights.svg
 */
...
registerIcon('free-rights', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconFreeRights'

export const ZcIconFreeRights = withInstall(_comp, 'ZcIconFreeRights')
