 ...
 * Source: icons/outline/box-margin.svg
 */
...
registerIcon('box-margin', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBoxMargin'

export const ZcIconBoxMargin = withInstall(_comp, 'ZcIconBoxMargin')
