 ...
 * Source: icons/outline/crane-off.svg
 */
...
registerIcon('crane-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCraneOff'

export const ZcIconCraneOff = withInstall(_comp, 'ZcIconCraneOff')
