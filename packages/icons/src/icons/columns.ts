 ...
 * Source: icons/outline/columns.svg
 */
...
registerIcon('columns', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconColumns'

export const ZcIconColumns = withInstall(_comp, 'ZcIconColumns')
