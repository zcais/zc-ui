 ...
 * Source: icons/outline/microphone-off.svg
 */
...
registerIcon('microphone-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconMicrophoneOff'

export const ZcIconMicrophoneOff = withInstall(_comp, 'ZcIconMicrophoneOff')
