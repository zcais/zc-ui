/**
 * ZcIconBorderHorizontal
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/border-horizontal.svg
 */
...
registerIcon('border-horizontal', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconBorderHorizontal'

export const ZcIconBorderHorizontal = withInstall(_comp, 'ZcIconBorderHorizontal')
