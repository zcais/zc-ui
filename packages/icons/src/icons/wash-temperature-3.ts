/**
 * ZcIconWashTemperature3
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/wash-temperature-3.svg
 */
...
registerIcon('wash-temperature-3', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconWashTemperature3'

export const ZcIconWashTemperature3 = withInstall(_comp, 'ZcIconWashTemperature3')
