 ...
 * Source: icons/outline/pointer-down.svg
 */
...
registerIcon('pointer-down', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconPointerDown'

export const ZcIconPointerDown = withInstall(_comp, 'ZcIconPointerDown')
