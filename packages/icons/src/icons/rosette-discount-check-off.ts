/**
 * ZcIconRosetteDiscountCheckOff
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/rosette-discount-check-off.svg
 */
...
registerIcon('rosette-discount-check-off', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconRosetteDiscountCheckOff'

export const ZcIconRosetteDiscountCheckOff = withInstall(_comp, 'ZcIconRosetteDiscountCheckOff')
