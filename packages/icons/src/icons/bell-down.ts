 ...
 * Source: icons/outline/bell-down.svg
 */
...
registerIcon('bell-down', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBellDown'

export const ZcIconBellDown = withInstall(_comp, 'ZcIconBellDown')
