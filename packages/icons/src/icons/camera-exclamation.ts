/**
 * ZcIconCameraExclamation
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/camera-exclamation.svg
 */
...
registerIcon('camera-exclamation', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconCameraExclamation'

export const ZcIconCameraExclamation = withInstall(_comp, 'ZcIconCameraExclamation')
