 ...
 * Source: icons/outline/progress-check.svg
 */
...
registerIcon('progress-check', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconProgressCheck'

export const ZcIconProgressCheck = withInstall(_comp, 'ZcIconProgressCheck')
