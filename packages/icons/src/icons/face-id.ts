 ...
 * Source: icons/outline/face-id.svg
 */
...
registerIcon('face-id', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconFaceId'

export const ZcIconFaceId = withInstall(_comp, 'ZcIconFaceId')
