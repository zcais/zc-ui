 ...
 * Source: icons/outline/abacus.svg
 */
...
registerIcon('abacus', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconAbacus'

export const ZcIconAbacus = withInstall(_comp, 'ZcIconAbacus')
