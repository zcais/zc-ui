 ...
 * Source: icons/outline/id-badge-off.svg
 */
...
registerIcon('id-badge-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconIdBadgeOff'

export const ZcIconIdBadgeOff = withInstall(_comp, 'ZcIconIdBadgeOff')
