 ...
 * Source: icons/outline/box-off.svg
 */
...
registerIcon('box-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBoxOff'

export const ZcIconBoxOff = withInstall(_comp, 'ZcIconBoxOff')
