 ...
 * Source: icons/outline/satellite-off.svg
 */
...
registerIcon('satellite-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconSatelliteOff'

export const ZcIconSatelliteOff = withInstall(_comp, 'ZcIconSatelliteOff')
