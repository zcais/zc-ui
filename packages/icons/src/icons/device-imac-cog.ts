 ...
 * Source: icons/outline/device-imac-cog.svg
 */
...
registerIcon('device-imac-cog', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconDeviceImacCog'

export const ZcIconDeviceImacCog = withInstall(_comp, 'ZcIconDeviceImacCog')
