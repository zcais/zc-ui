...
registerIcon('edit', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconEdit'

export const ZcIconEdit = withInstall(_comp, 'ZcIconEdit')
