 ...
 * Source: icons/outline/code-asterisk.svg
 */
...
registerIcon('code-asterisk', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCodeAsterisk'

export const ZcIconCodeAsterisk = withInstall(_comp, 'ZcIconCodeAsterisk')
