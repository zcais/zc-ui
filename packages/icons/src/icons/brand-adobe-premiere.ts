/**
 * ZcIconBrandAdobePremiere
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/brand-adobe-premiere.svg
 */
...
registerIcon('brand-adobe-premiere', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconBrandAdobePremiere'

export const ZcIconBrandAdobePremiere = withInstall(_comp, 'ZcIconBrandAdobePremiere')
