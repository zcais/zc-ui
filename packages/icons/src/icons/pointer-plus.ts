 ...
 * Source: icons/outline/pointer-plus.svg
 */
...
registerIcon('pointer-plus', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconPointerPlus'

export const ZcIconPointerPlus = withInstall(_comp, 'ZcIconPointerPlus')
