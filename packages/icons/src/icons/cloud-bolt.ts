 ...
 * Source: icons/outline/cloud-bolt.svg
 */
...
registerIcon('cloud-bolt', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCloudBolt'

export const ZcIconCloudBolt = withInstall(_comp, 'ZcIconCloudBolt')
