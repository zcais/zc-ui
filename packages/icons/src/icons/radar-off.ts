 ...
 * Source: icons/outline/radar-off.svg
 */
...
registerIcon('radar-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconRadarOff'

export const ZcIconRadarOff = withInstall(_comp, 'ZcIconRadarOff')
