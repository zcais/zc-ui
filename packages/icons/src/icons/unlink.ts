 ...
 * Source: icons/outline/unlink.svg
 */
...
registerIcon('unlink', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconUnlink'

export const ZcIconUnlink = withInstall(_comp, 'ZcIconUnlink')
