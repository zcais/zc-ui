 ...
 * Source: icons/outline/beach.svg
 */
...
registerIcon('beach', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBeach'

export const ZcIconBeach = withInstall(_comp, 'ZcIconBeach')
