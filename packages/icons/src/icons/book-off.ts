 ...
 * Source: icons/outline/book-off.svg
 */
...
registerIcon('book-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBookOff'

export const ZcIconBookOff = withInstall(_comp, 'ZcIconBookOff')
