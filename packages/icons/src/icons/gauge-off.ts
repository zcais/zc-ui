 ...
 * Source: icons/outline/gauge-off.svg
 */
...
registerIcon('gauge-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconGaugeOff'

export const ZcIconGaugeOff = withInstall(_comp, 'ZcIconGaugeOff')
