/**
 * ZcIconPanoramaHorizontalOff
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/panorama-horizontal-off.svg
 */
...
registerIcon('panorama-horizontal-off', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconPanoramaHorizontalOff'

export const ZcIconPanoramaHorizontalOff = withInstall(_comp, 'ZcIconPanoramaHorizontalOff')
