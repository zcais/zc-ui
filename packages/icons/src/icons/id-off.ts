 ...
 * Source: icons/outline/id-off.svg
 */
...
registerIcon('id-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconIdOff'

export const ZcIconIdOff = withInstall(_comp, 'ZcIconIdOff')
