 ...
 * Source: icons/outline/receipt-off.svg
 */
...
registerIcon('receipt-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconReceiptOff'

export const ZcIconReceiptOff = withInstall(_comp, 'ZcIconReceiptOff')
