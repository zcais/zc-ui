 ...
 * Source: icons/outline/heart-off.svg
 */
...
registerIcon('heart-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconHeartOff'

export const ZcIconHeartOff = withInstall(_comp, 'ZcIconHeartOff')
