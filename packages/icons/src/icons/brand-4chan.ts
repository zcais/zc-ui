 ...
 * Source: icons/outline/brand-4chan.svg
 */
...
registerIcon('brand-4chan', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBrand4chan'

export const ZcIconBrand4chan = withInstall(_comp, 'ZcIconBrand4chan')
