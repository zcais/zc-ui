 ...
 * Source: icons/outline/quote.svg
 */
...
registerIcon('quote', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconQuote'

export const ZcIconQuote = withInstall(_comp, 'ZcIconQuote')
