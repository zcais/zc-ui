 ...
 * Source: icons/outline/photo-up.svg
 */
...
registerIcon('photo-up', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconPhotoUp'

export const ZcIconPhotoUp = withInstall(_comp, 'ZcIconPhotoUp')
