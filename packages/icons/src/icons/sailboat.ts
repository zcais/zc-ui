 ...
 * Source: icons/outline/sailboat.svg
 */
...
registerIcon('sailboat', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconSailboat'

export const ZcIconSailboat = withInstall(_comp, 'ZcIconSailboat')
