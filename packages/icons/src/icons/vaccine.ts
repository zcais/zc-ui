 ...
 * Source: icons/outline/vaccine.svg
 */
...
registerIcon('vaccine', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconVaccine'

export const ZcIconVaccine = withInstall(_comp, 'ZcIconVaccine')
