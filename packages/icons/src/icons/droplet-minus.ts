 ...
 * Source: icons/outline/droplet-minus.svg
 */
...
registerIcon('droplet-minus', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconDropletMinus'

export const ZcIconDropletMinus = withInstall(_comp, 'ZcIconDropletMinus')
