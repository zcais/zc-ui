 ...
 * Source: icons/outline/file-infinity.svg
 */
...
registerIcon('file-infinity', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconFileInfinity'

export const ZcIconFileInfinity = withInstall(_comp, 'ZcIconFileInfinity')
