 ...
 * Source: icons/outline/at-off.svg
 */
...
registerIcon('at-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconAtOff'

export const ZcIconAtOff = withInstall(_comp, 'ZcIconAtOff')
