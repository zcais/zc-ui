 ...
 * Source: icons/outline/database-edit.svg
 */
...
registerIcon('database-edit', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconDatabaseEdit'

export const ZcIconDatabaseEdit = withInstall(_comp, 'ZcIconDatabaseEdit')
