 ...
 * Source: icons/outline/brand-zapier.svg
 */
...
registerIcon('brand-zapier', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBrandZapier'

export const ZcIconBrandZapier = withInstall(_comp, 'ZcIconBrandZapier')
