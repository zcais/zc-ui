 ...
 * Source: icons/outline/photo-plus.svg
 */
...
registerIcon('photo-plus', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconPhotoPlus'

export const ZcIconPhotoPlus = withInstall(_comp, 'ZcIconPhotoPlus')
