 ...
 * Source: icons/outline/swimming.svg
 */
...
registerIcon('swimming', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconSwimming'

export const ZcIconSwimming = withInstall(_comp, 'ZcIconSwimming')
