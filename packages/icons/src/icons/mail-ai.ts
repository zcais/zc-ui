 ...
 * Source: icons/outline/mail-ai.svg
 */
...
registerIcon('mail-ai', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconMailAi'

export const ZcIconMailAi = withInstall(_comp, 'ZcIconMailAi')
