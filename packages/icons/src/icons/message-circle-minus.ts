/**
 * ZcIconMessageCircleMinus
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/message-circle-minus.svg
 */
...
registerIcon('message-circle-minus', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconMessageCircleMinus'

export const ZcIconMessageCircleMinus = withInstall(_comp, 'ZcIconMessageCircleMinus')
