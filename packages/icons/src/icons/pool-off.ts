 ...
 * Source: icons/outline/pool-off.svg
 */
...
registerIcon('pool-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconPoolOff'

export const ZcIconPoolOff = withInstall(_comp, 'ZcIconPoolOff')
