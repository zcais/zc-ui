/**
 * ZcIconPentagonNumber6
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/pentagon-number-6.svg
 */
...
registerIcon('pentagon-number-6', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconPentagonNumber6'

export const ZcIconPentagonNumber6 = withInstall(_comp, 'ZcIconPentagonNumber6')
