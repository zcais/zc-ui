 ...
 * Source: icons/outline/medical-cross.svg
 */
...
registerIcon('medical-cross', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconMedicalCross'

export const ZcIconMedicalCross = withInstall(_comp, 'ZcIconMedicalCross')
