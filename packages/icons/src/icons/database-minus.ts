 ...
 * Source: icons/outline/database-minus.svg
 */
...
registerIcon('database-minus', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconDatabaseMinus'

export const ZcIconDatabaseMinus = withInstall(_comp, 'ZcIconDatabaseMinus')
