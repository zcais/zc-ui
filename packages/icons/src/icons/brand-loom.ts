 ...
 * Source: icons/outline/brand-loom.svg
 */
...
registerIcon('brand-loom', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBrandLoom'

export const ZcIconBrandLoom = withInstall(_comp, 'ZcIconBrandLoom')
