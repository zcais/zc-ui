 ...
 * Source: icons/outline/table-row.svg
 */
...
registerIcon('table-row', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconTableRow'

export const ZcIconTableRow = withInstall(_comp, 'ZcIconTableRow')
