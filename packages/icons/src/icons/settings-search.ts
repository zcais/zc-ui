/**
 * ZcIconSettingsSearch
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/settings-search.svg
 */
...
registerIcon('settings-search', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconSettingsSearch'

export const ZcIconSettingsSearch = withInstall(_comp, 'ZcIconSettingsSearch')
