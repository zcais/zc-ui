 ...
 * Source: icons/outline/brand-react.svg
 */
...
registerIcon('brand-react', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBrandReact'

export const ZcIconBrandReact = withInstall(_comp, 'ZcIconBrandReact')
