 ...
 * Source: icons/outline/key-off.svg
 */
...
registerIcon('key-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconKeyOff'

export const ZcIconKeyOff = withInstall(_comp, 'ZcIconKeyOff')
