 ...
 * Source: icons/outline/click.svg
 */
...
registerIcon('click', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconClick'

export const ZcIconClick = withInstall(_comp, 'ZcIconClick')
