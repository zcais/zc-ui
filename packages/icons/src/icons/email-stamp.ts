 ...
 * Source: icons/outline/email-stamp.svg
 */
...
_comp.displayName = 'ZcIconEmailStamp'

export const ZcIconEmailStamp = withInstall(_comp, 'ZcIconEmailStamp')
