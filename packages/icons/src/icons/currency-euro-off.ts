/**
 * ZcIconCurrencyEuroOff
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/currency-euro-off.svg
 */
...
registerIcon('currency-euro-off', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconCurrencyEuroOff'

export const ZcIconCurrencyEuroOff = withInstall(_comp, 'ZcIconCurrencyEuroOff')
