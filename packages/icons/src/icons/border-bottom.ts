 ...
 * Source: icons/outline/border-bottom.svg
 */
...
registerIcon('border-bottom', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBorderBottom'

export const ZcIconBorderBottom = withInstall(_comp, 'ZcIconBorderBottom')
