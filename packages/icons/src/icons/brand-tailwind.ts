 ...
 * Source: icons/outline/brand-tailwind.svg
 */
...
registerIcon('brand-tailwind', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBrandTailwind'

export const ZcIconBrandTailwind = withInstall(_comp, 'ZcIconBrandTailwind')
