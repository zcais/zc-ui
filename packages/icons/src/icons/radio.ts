 ...
 * Source: icons/outline/radio.svg
 */
...
registerIcon('radio', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconRadio'

export const ZcIconRadio = withInstall(_comp, 'ZcIconRadio')
