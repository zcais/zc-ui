 ...
 * Source: icons/outline/assembly-off.svg
 */
...
_comp.displayName = 'ZcIconAssemblyOff'

export const ZcIconAssemblyOff = withInstall(_comp, 'ZcIconAssemblyOff')
