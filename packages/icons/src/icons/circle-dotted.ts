 ...
 * Source: icons/outline/circle-dotted.svg
 */
...
registerIcon('circle-dotted', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCircleDotted'

export const ZcIconCircleDotted = withInstall(_comp, 'ZcIconCircleDotted')
