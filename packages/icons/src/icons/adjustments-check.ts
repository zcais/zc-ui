/**
 * ZcIconAdjustmentsCheck
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/adjustments-check.svg
 */
...
registerIcon('adjustments-check', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconAdjustmentsCheck'

export const ZcIconAdjustmentsCheck = withInstall(_comp, 'ZcIconAdjustmentsCheck')
