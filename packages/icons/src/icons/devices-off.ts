 ...
 * Source: icons/outline/devices-off.svg
 */
...
registerIcon('devices-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconDevicesOff'

export const ZcIconDevicesOff = withInstall(_comp, 'ZcIconDevicesOff')
