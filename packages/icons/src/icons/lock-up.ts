 ...
 * Source: icons/outline/lock-up.svg
 */
...
registerIcon('lock-up', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconLockUp'

export const ZcIconLockUp = withInstall(_comp, 'ZcIconLockUp')
