 ...
 * Source: icons/outline/ruler.svg
 */
...
registerIcon('ruler', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconRuler'

export const ZcIconRuler = withInstall(_comp, 'ZcIconRuler')
