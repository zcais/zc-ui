 ...
 * Source: icons/outline/file-text-ai.svg
 */
...
registerIcon('file-text-ai', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconFileTextAi'

export const ZcIconFileTextAi = withInstall(_comp, 'ZcIconFileTextAi')
