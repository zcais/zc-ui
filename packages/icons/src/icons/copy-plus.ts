 ...
 * Source: icons/outline/copy-plus.svg
 */
...
registerIcon('copy-plus', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCopyPlus'

export const ZcIconCopyPlus = withInstall(_comp, 'ZcIconCopyPlus')
