 ...
 * Source: icons/outline/droplet-check.svg
 */
...
registerIcon('droplet-check', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconDropletCheck'

export const ZcIconDropletCheck = withInstall(_comp, 'ZcIconDropletCheck')
