 ...
 * Source: icons/outline/gas-station-off.svg
 */
...
registerIcon('gas-station-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconGasStationOff'

export const ZcIconGasStationOff = withInstall(_comp, 'ZcIconGasStationOff')
