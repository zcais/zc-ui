 ...
 * Source: icons/outline/calendar-week.svg
 */
...
registerIcon('calendar-week', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCalendarWeek'

export const ZcIconCalendarWeek = withInstall(_comp, 'ZcIconCalendarWeek')
