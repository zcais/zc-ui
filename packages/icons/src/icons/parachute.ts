 ...
 * Source: icons/outline/parachute.svg
 */
...
registerIcon('parachute', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconParachute'

export const ZcIconParachute = withInstall(_comp, 'ZcIconParachute')
