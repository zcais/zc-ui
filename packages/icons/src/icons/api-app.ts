 ...
 * Source: icons/outline/api-app.svg
 */
...
registerIcon('api-app', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconApiApp'

export const ZcIconApiApp = withInstall(_comp, 'ZcIconApiApp')
