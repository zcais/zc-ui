 ...
 * Source: icons/outline/ship-off.svg
 */
...
registerIcon('ship-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconShipOff'

export const ZcIconShipOff = withInstall(_comp, 'ZcIconShipOff')
