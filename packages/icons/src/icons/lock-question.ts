 ...
 * Source: icons/outline/lock-question.svg
 */
...
registerIcon('lock-question', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconLockQuestion'

export const ZcIconLockQuestion = withInstall(_comp, 'ZcIconLockQuestion')
