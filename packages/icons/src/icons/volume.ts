 ...
 * Source: icons/outline/volume.svg
 */
...
registerIcon('volume', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconVolume'

export const ZcIconVolume = withInstall(_comp, 'ZcIconVolume')
