 ...
 * Source: icons/outline/droplet-cog.svg
 */
...
registerIcon('droplet-cog', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconDropletCog'

export const ZcIconDropletCog = withInstall(_comp, 'ZcIconDropletCog')
