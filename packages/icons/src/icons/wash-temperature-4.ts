/**
 * ZcIconWashTemperature4
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/wash-temperature-4.svg
 */
...
registerIcon('wash-temperature-4', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconWashTemperature4'

export const ZcIconWashTemperature4 = withInstall(_comp, 'ZcIconWashTemperature4')
