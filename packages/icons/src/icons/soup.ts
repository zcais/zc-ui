...
registerIcon('soup', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconSoup'

export const ZcIconSoup = withInstall(_comp, 'ZcIconSoup')
