 ...
 * Source: icons/outline/sunset-2.svg
 */
...
registerIcon('sunset-2', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconSunset2'

export const ZcIconSunset2 = withInstall(_comp, 'ZcIconSunset2')
