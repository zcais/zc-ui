 ...
 * Source: icons/outline/device-imac-off.svg
 */
...
registerIcon('device-imac-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconDeviceImacOff'

export const ZcIconDeviceImacOff = withInstall(_comp, 'ZcIconDeviceImacOff')
