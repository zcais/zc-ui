...
registerIcon('wand', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconWand'

export const ZcIconWand = withInstall(_comp, 'ZcIconWand')
