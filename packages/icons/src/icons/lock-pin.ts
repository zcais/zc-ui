 ...
 * Source: icons/outline/lock-pin.svg
 */
...
registerIcon('lock-pin', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconLockPin'

export const ZcIconLockPin = withInstall(_comp, 'ZcIconLockPin')
