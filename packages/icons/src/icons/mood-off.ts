 ...
 * Source: icons/outline/mood-off.svg
 */
...
registerIcon('mood-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconMoodOff'

export const ZcIconMoodOff = withInstall(_comp, 'ZcIconMoodOff')
