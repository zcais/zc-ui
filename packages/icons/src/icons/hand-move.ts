 ...
 * Source: icons/outline/hand-move.svg
 */
...
registerIcon('hand-move', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconHandMove'

export const ZcIconHandMove = withInstall(_comp, 'ZcIconHandMove')
