...
registerIcon('cast', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCast'

export const ZcIconCast = withInstall(_comp, 'ZcIconCast')
