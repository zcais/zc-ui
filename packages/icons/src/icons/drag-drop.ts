 ...
 * Source: icons/outline/drag-drop.svg
 */
...
registerIcon('drag-drop', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconDragDrop'

export const ZcIconDragDrop = withInstall(_comp, 'ZcIconDragDrop')
