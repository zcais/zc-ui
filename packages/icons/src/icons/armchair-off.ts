 ...
 * Source: icons/outline/armchair-off.svg
 */
...
registerIcon('armchair-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconArmchairOff'

export const ZcIconArmchairOff = withInstall(_comp, 'ZcIconArmchairOff')
