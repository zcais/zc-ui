 ...
 * Source: icons/outline/adjustments.svg
 */
...
registerIcon('adjustments', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconAdjustments'

export const ZcIconAdjustments = withInstall(_comp, 'ZcIconAdjustments')
