 ...
 * Source: icons/outline/parking-off.svg
 */
...
registerIcon('parking-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconParkingOff'

export const ZcIconParkingOff = withInstall(_comp, 'ZcIconParkingOff')
