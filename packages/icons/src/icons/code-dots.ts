 ...
 * Source: icons/outline/code-dots.svg
 */
...
registerIcon('code-dots', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCodeDots'

export const ZcIconCodeDots = withInstall(_comp, 'ZcIconCodeDots')
