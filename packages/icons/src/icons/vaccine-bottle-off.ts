/**
 * ZcIconVaccineBottleOff
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/vaccine-bottle-off.svg
 */
...
registerIcon('vaccine-bottle-off', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconVaccineBottleOff'

export const ZcIconVaccineBottleOff = withInstall(_comp, 'ZcIconVaccineBottleOff')
