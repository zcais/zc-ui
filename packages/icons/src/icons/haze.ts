...
registerIcon('haze', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconHaze'

export const ZcIconHaze = withInstall(_comp, 'ZcIconHaze')
