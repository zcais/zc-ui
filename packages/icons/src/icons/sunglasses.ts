 ...
 * Source: icons/outline/sunglasses.svg
 */
...
registerIcon('sunglasses', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconSunglasses'

export const ZcIconSunglasses = withInstall(_comp, 'ZcIconSunglasses')
