 ...
 * Source: icons/outline/world-www.svg
 */
...
registerIcon('world-www', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconWorldWww'

export const ZcIconWorldWww = withInstall(_comp, 'ZcIconWorldWww')
