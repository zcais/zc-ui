 ...
 * Source: icons/outline/virus-off.svg
 */
...
registerIcon('virus-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconVirusOff'

export const ZcIconVirusOff = withInstall(_comp, 'ZcIconVirusOff')
