...
registerIcon('ship', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconShip'

export const ZcIconShip = withInstall(_comp, 'ZcIconShip')
