 ...
 * Source: icons/outline/database-heart.svg
 */
...
registerIcon('database-heart', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconDatabaseHeart'

export const ZcIconDatabaseHeart = withInstall(_comp, 'ZcIconDatabaseHeart')
