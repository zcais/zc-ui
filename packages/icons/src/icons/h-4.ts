...
registerIcon('h-4', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconH4'

export const ZcIconH4 = withInstall(_comp, 'ZcIconH4')
