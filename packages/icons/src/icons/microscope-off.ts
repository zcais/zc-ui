 ...
 * Source: icons/outline/microscope-off.svg
 */
...
registerIcon('microscope-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconMicroscopeOff'

export const ZcIconMicroscopeOff = withInstall(_comp, 'ZcIconMicroscopeOff')
