 ...
 * Source: icons/outline/diabolo.svg
 */
...
registerIcon('diabolo', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconDiabolo'

export const ZcIconDiabolo = withInstall(_comp, 'ZcIconDiabolo')
