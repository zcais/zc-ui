...
registerIcon('lego', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconLego'

export const ZcIconLego = withInstall(_comp, 'ZcIconLego')
