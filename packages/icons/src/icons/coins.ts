 ...
 * Source: icons/outline/coins.svg
 */
...
registerIcon('coins', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCoins'

export const ZcIconCoins = withInstall(_comp, 'ZcIconCoins')
