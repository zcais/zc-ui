 ...
 * Source: icons/outline/folders-off.svg
 */
...
registerIcon('folders-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconFoldersOff'

export const ZcIconFoldersOff = withInstall(_comp, 'ZcIconFoldersOff')
