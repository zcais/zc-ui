 ...
 * Source: icons/outline/crutches-off.svg
 */
...
registerIcon('crutches-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCrutchesOff'

export const ZcIconCrutchesOff = withInstall(_comp, 'ZcIconCrutchesOff')
