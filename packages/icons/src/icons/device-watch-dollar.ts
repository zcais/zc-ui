/**
 * ZcIconDeviceWatchDollar
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/device-watch-dollar.svg
 */
...
registerIcon('device-watch-dollar', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconDeviceWatchDollar'

export const ZcIconDeviceWatchDollar = withInstall(_comp, 'ZcIconDeviceWatchDollar')
