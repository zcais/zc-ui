 ...
 * Source: icons/outline/hand-click.svg
 */
...
registerIcon('hand-click', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconHandClick'

export const ZcIconHandClick = withInstall(_comp, 'ZcIconHandClick')
