/**
 * ZcIconDeviceImacShare
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/device-imac-share.svg
 */
...
registerIcon('device-imac-share', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconDeviceImacShare'

export const ZcIconDeviceImacShare = withInstall(_comp, 'ZcIconDeviceImacShare')
