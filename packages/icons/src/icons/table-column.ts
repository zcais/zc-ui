 ...
 * Source: icons/outline/table-column.svg
 */
...
registerIcon('table-column', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconTableColumn'

export const ZcIconTableColumn = withInstall(_comp, 'ZcIconTableColumn')
