...
registerIcon('link', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconLink'

export const ZcIconLink = withInstall(_comp, 'ZcIconLink')
