 ...
 * Source: icons/outline/discount-off.svg
 */
...
registerIcon('discount-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconDiscountOff'

export const ZcIconDiscountOff = withInstall(_comp, 'ZcIconDiscountOff')
