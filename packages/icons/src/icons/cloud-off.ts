 ...
 * Source: icons/outline/cloud-off.svg
 */
...
registerIcon('cloud-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCloudOff'

export const ZcIconCloudOff = withInstall(_comp, 'ZcIconCloudOff')
