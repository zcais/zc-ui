 ...
 * Source: icons/outline/signal-3g.svg
 */
...
registerIcon('signal-3g', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconSignal3g'

export const ZcIconSignal3g = withInstall(_comp, 'ZcIconSignal3g')
