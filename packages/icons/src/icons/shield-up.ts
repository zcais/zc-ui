 ...
 * Source: icons/outline/shield-up.svg
 */
...
registerIcon('shield-up', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconShieldUp'

export const ZcIconShieldUp = withInstall(_comp, 'ZcIconShieldUp')
