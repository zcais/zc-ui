 ...
 * Source: icons/outline/droplet-pause.svg
 */
...
registerIcon('droplet-pause', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconDropletPause'

export const ZcIconDropletPause = withInstall(_comp, 'ZcIconDropletPause')
