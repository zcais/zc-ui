 ...
 * Source: icons/outline/laurel-wreath-1.svg
 */
...
registerIcon('laurel-wreath-1', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconLaurelWreath1'

export const ZcIconLaurelWreath1 = withInstall(_comp, 'ZcIconLaurelWreath1')
