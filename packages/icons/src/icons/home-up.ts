 ...
 * Source: icons/outline/home-up.svg
 */
...
registerIcon('home-up', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconHomeUp'

export const ZcIconHomeUp = withInstall(_comp, 'ZcIconHomeUp')
