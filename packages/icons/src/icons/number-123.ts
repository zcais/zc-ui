 ...
 * Source: icons/outline/number-123.svg
 */
...
registerIcon('number-123', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconNumber123'

export const ZcIconNumber123 = withInstall(_comp, 'ZcIconNumber123')
