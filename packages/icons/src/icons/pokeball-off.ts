 ...
 * Source: icons/outline/pokeball-off.svg
 */
...
registerIcon('pokeball-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconPokeballOff'

export const ZcIconPokeballOff = withInstall(_comp, 'ZcIconPokeballOff')
