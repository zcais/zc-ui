 ...
 * Source: icons/outline/photo-off.svg
 */
...
registerIcon('photo-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconPhotoOff'

export const ZcIconPhotoOff = withInstall(_comp, 'ZcIconPhotoOff')
