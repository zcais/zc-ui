 ...
 * Source: icons/outline/seedling-off.svg
 */
...
registerIcon('seedling-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconSeedlingOff'

export const ZcIconSeedlingOff = withInstall(_comp, 'ZcIconSeedlingOff')
