 ...
 * Source: icons/outline/lock-pause.svg
 */
...
registerIcon('lock-pause', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconLockPause'

export const ZcIconLockPause = withInstall(_comp, 'ZcIconLockPause')
