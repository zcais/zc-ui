/**
 * ZcIconMessageCircleDollar
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/message-circle-dollar.svg
 */
...
registerIcon('message-circle-dollar', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconMessageCircleDollar'

export const ZcIconMessageCircleDollar = withInstall(_comp, 'ZcIconMessageCircleDollar')
