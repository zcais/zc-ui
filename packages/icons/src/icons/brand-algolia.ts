 ...
 * Source: icons/outline/brand-algolia.svg
 */
...
registerIcon('brand-algolia', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBrandAlgolia'

export const ZcIconBrandAlgolia = withInstall(_comp, 'ZcIconBrandAlgolia')
