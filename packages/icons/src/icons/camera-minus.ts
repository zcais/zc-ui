 ...
 * Source: icons/outline/camera-minus.svg
 */
...
registerIcon('camera-minus', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCameraMinus'

export const ZcIconCameraMinus = withInstall(_comp, 'ZcIconCameraMinus')
