 ...
 * Source: icons/outline/recycle-off.svg
 */
...
registerIcon('recycle-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconRecycleOff'

export const ZcIconRecycleOff = withInstall(_comp, 'ZcIconRecycleOff')
