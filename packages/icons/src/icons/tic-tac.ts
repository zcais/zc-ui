 ...
 * Source: icons/outline/tic-tac.svg
 */
...
registerIcon('tic-tac', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconTicTac'

export const ZcIconTicTac = withInstall(_comp, 'ZcIconTicTac')
