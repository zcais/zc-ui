 ...
 * Source: icons/outline/photo-pause.svg
 */
...
registerIcon('photo-pause', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconPhotoPause'

export const ZcIconPhotoPause = withInstall(_comp, 'ZcIconPhotoPause')
