 ...
 * Source: icons/outline/anchor-off.svg
 */
...
registerIcon('anchor-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconAnchorOff'

export const ZcIconAnchorOff = withInstall(_comp, 'ZcIconAnchorOff')
