 ...
 * Source: icons/outline/chart-column.svg
 */
...
registerIcon('chart-column', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconChartColumn'

export const ZcIconChartColumn = withInstall(_comp, 'ZcIconChartColumn')
