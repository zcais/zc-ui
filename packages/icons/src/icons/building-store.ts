 ...
 * Source: icons/outline/building-store.svg
 */
...
registerIcon('building-store', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBuildingStore'

export const ZcIconBuildingStore = withInstall(_comp, 'ZcIconBuildingStore')
