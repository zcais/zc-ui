 ...
 * Source: icons/outline/meat-off.svg
 */
...
registerIcon('meat-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconMeatOff'

export const ZcIconMeatOff = withInstall(_comp, 'ZcIconMeatOff')
