 ...
 * Source: icons/outline/manual-gearbox.svg
 */
...
registerIcon('manual-gearbox', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconManualGearbox'

export const ZcIconManualGearbox = withInstall(_comp, 'ZcIconManualGearbox')
