 ...
 * Source: icons/outline/camera-selfie.svg
 */
...
registerIcon('camera-selfie', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCameraSelfie'

export const ZcIconCameraSelfie = withInstall(_comp, 'ZcIconCameraSelfie')
