/**
 * ZcIconDatabaseExport
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/database-export.svg
 */
...
registerIcon('database-export', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconDatabaseExport'

export const ZcIconDatabaseExport = withInstall(_comp, 'ZcIconDatabaseExport')
