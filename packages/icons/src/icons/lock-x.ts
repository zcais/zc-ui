 ...
 * Source: icons/outline/lock-x.svg
 */
...
registerIcon('lock-x', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconLockX'

export const ZcIconLockX = withInstall(_comp, 'ZcIconLockX')
