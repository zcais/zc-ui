...
registerIcon('jpg', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconJpg'

export const ZcIconJpg = withInstall(_comp, 'ZcIconJpg')
