 ...
 * Source: icons/outline/laurel-wreath-3.svg
 */
...
registerIcon('laurel-wreath-3', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconLaurelWreath3'

export const ZcIconLaurelWreath3 = withInstall(_comp, 'ZcIconLaurelWreath3')
