 ...
 * Source: icons/outline/puzzle-2.svg
 */
...
registerIcon('puzzle-2', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconPuzzle2'

export const ZcIconPuzzle2 = withInstall(_comp, 'ZcIconPuzzle2')
