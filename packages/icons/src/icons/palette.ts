 ...
 * Source: icons/outline/palette.svg
 */
...
registerIcon('palette', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconPalette'

export const ZcIconPalette = withInstall(_comp, 'ZcIconPalette')
