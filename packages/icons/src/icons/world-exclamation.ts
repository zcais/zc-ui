/**
 * ZcIconWorldExclamation
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/world-exclamation.svg
 */
...
registerIcon('world-exclamation', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconWorldExclamation'

export const ZcIconWorldExclamation = withInstall(_comp, 'ZcIconWorldExclamation')
