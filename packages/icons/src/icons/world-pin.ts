 ...
 * Source: icons/outline/world-pin.svg
 */
...
registerIcon('world-pin', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconWorldPin'

export const ZcIconWorldPin = withInstall(_comp, 'ZcIconWorldPin')
