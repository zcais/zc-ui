 ...
 * Source: icons/outline/hand-finger.svg
 */
...
registerIcon('hand-finger', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconHandFinger'

export const ZcIconHandFinger = withInstall(_comp, 'ZcIconHandFinger')
