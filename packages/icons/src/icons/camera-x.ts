 ...
 * Source: icons/outline/camera-x.svg
 */
...
registerIcon('camera-x', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCameraX'

export const ZcIconCameraX = withInstall(_comp, 'ZcIconCameraX')
