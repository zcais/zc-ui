 ...
 * Source: icons/outline/invoice.svg
 */
...
registerIcon('invoice', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconInvoice'

export const ZcIconInvoice = withInstall(_comp, 'ZcIconInvoice')
