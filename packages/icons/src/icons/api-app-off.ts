 ...
 * Source: icons/outline/api-app-off.svg
 */
...
registerIcon('api-app-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconApiAppOff'

export const ZcIconApiAppOff = withInstall(_comp, 'ZcIconApiAppOff')
