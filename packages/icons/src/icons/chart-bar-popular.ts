/**
 * ZcIconChartBarPopular
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/chart-bar-popular.svg
 */
...
registerIcon('chart-bar-popular', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconChartBarPopular'

export const ZcIconChartBarPopular = withInstall(_comp, 'ZcIconChartBarPopular')
