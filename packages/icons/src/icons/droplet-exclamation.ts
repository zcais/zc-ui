/**
 * ZcIconDropletExclamation
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/droplet-exclamation.svg
 */
...
registerIcon('droplet-exclamation', {
  path: _body,
  viewBox: '0 0 24 24',
  strokeWidth: 2,
  fill: 'none',
...
_comp.displayName = 'ZcIconDropletExclamation'

export const ZcIconDropletExclamation = withInstall(_comp, 'ZcIconDropletExclamation')
