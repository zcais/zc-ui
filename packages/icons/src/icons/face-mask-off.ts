 ...
 * Source: icons/outline/face-mask-off.svg
 */
...
registerIcon('face-mask-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconFaceMaskOff'

export const ZcIconFaceMaskOff = withInstall(_comp, 'ZcIconFaceMaskOff')
