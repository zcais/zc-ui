 ...
 * Source: icons/outline/bell-check.svg
 */
...
registerIcon('bell-check', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBellCheck'

export const ZcIconBellCheck = withInstall(_comp, 'ZcIconBellCheck')
