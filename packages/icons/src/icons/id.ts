...
registerIcon('id', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconId'

export const ZcIconId = withInstall(_comp, 'ZcIconId')
