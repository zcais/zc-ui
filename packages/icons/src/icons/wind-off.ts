 ...
 * Source: icons/outline/wind-off.svg
 */
...
registerIcon('wind-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconWindOff'

export const ZcIconWindOff = withInstall(_comp, 'ZcIconWindOff')
