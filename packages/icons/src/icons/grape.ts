 ...
 * Source: icons/outline/grape.svg
 */
...
registerIcon('grape', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconGrape'

export const ZcIconGrape = withInstall(_comp, 'ZcIconGrape')
