 ...
 * Source: icons/outline/award-off.svg
 */
...
registerIcon('award-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconAwardOff'

export const ZcIconAwardOff = withInstall(_comp, 'ZcIconAwardOff')
