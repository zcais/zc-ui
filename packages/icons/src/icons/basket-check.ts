 ...
 * Source: icons/outline/basket-check.svg
 */
...
registerIcon('basket-check', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBasketCheck'

export const ZcIconBasketCheck = withInstall(_comp, 'ZcIconBasketCheck')
