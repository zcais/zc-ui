 ...
 * Source: icons/outline/pointer-share.svg
 */
...
registerIcon('pointer-share', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconPointerShare'

export const ZcIconPointerShare = withInstall(_comp, 'ZcIconPointerShare')
