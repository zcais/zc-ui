 ...
 * Source: icons/outline/settings-cog.svg
 */
...
registerIcon('settings-cog', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconSettingsCog'

export const ZcIconSettingsCog = withInstall(_comp, 'ZcIconSettingsCog')
