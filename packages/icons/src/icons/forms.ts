 ...
 * Source: icons/outline/forms.svg
 */
...
registerIcon('forms', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconForms'

export const ZcIconForms = withInstall(_comp, 'ZcIconForms')
