 ...
 * Source: icons/outline/world-plus.svg
 */
...
registerIcon('world-plus', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconWorldPlus'

export const ZcIconWorldPlus = withInstall(_comp, 'ZcIconWorldPlus')
