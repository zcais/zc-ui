 ...
 * Source: icons/outline/vocabulary-off.svg
 */
...
registerIcon('vocabulary-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconVocabularyOff'

export const ZcIconVocabularyOff = withInstall(_comp, 'ZcIconVocabularyOff')
