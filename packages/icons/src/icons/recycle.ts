 ...
 * Source: icons/outline/recycle.svg
 */
...
registerIcon('recycle', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconRecycle'

export const ZcIconRecycle = withInstall(_comp, 'ZcIconRecycle')
