 ...
 * Source: icons/outline/laurel-wreath.svg
 */
...
registerIcon('laurel-wreath', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconLaurelWreath'

export const ZcIconLaurelWreath = withInstall(_comp, 'ZcIconLaurelWreath')
