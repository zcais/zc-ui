 ...
 * Source: icons/outline/brand-slack.svg
 */
...
registerIcon('brand-slack', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBrandSlack'

export const ZcIconBrandSlack = withInstall(_comp, 'ZcIconBrandSlack')
