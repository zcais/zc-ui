 ...
 * Source: icons/outline/map-pin-x.svg
 */
...
registerIcon('map-pin-x', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconMapPinX'

export const ZcIconMapPinX = withInstall(_comp, 'ZcIconMapPinX')
