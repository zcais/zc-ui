 ...
 * Source: icons/outline/lock-off.svg
 */
...
registerIcon('lock-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconLockOff'

export const ZcIconLockOff = withInstall(_comp, 'ZcIconLockOff')
