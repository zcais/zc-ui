 ...
 * Source: icons/outline/settings-pin.svg
 */
...
registerIcon('settings-pin', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconSettingsPin'

export const ZcIconSettingsPin = withInstall(_comp, 'ZcIconSettingsPin')
