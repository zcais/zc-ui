...
registerIcon('svg', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconSvg'

export const ZcIconSvg = withInstall(_comp, 'ZcIconSvg')
