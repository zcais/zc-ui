 ...
 * Source: icons/outline/briefcase-off.svg
 */
...
registerIcon('briefcase-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBriefcaseOff'

export const ZcIconBriefcaseOff = withInstall(_comp, 'ZcIconBriefcaseOff')
