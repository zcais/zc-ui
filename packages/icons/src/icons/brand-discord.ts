 ...
 * Source: icons/outline/brand-discord.svg
 */
...
registerIcon('brand-discord', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBrandDiscord'

export const ZcIconBrandDiscord = withInstall(_comp, 'ZcIconBrandDiscord')
