 ...
 * Source: icons/outline/camera-down.svg
 */
...
registerIcon('camera-down', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconCameraDown'

export const ZcIconCameraDown = withInstall(_comp, 'ZcIconCameraDown')
