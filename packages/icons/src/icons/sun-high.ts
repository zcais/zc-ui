 ...
 * Source: icons/outline/sun-high.svg
 */
...
registerIcon('sun-high', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconSunHigh'

export const ZcIconSunHigh = withInstall(_comp, 'ZcIconSunHigh')
