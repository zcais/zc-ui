 ...
 * Source: icons/outline/border-top.svg
 */
...
registerIcon('border-top', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBorderTop'

export const ZcIconBorderTop = withInstall(_comp, 'ZcIconBorderTop')
