 ...
 * Source: icons/outline/engine-off.svg
 */
...
registerIcon('engine-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconEngineOff'

export const ZcIconEngineOff = withInstall(_comp, 'ZcIconEngineOff')
