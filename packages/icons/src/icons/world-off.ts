 ...
 * Source: icons/outline/world-off.svg
 */
...
registerIcon('world-off', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconWorldOff'

export const ZcIconWorldOff = withInstall(_comp, 'ZcIconWorldOff')
