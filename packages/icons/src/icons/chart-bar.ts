 ...
 * Source: icons/outline/chart-bar.svg
 */
...
registerIcon('chart-bar', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconChartBar'

export const ZcIconChartBar = withInstall(_comp, 'ZcIconChartBar')
