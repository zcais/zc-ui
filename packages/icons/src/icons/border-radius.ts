 ...
 * Source: icons/outline/border-radius.svg
 */
...
registerIcon('border-radius', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBorderRadius'

export const ZcIconBorderRadius = withInstall(_comp, 'ZcIconBorderRadius')
