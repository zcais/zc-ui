/**
 * ZcIconBorderVertical
 *
 * Auto-generated from @tabler/icons — do not edit manually.
 * Source: icons/outline/border-vertical.svg
 */
...
registerIcon('border-vertical', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBorderVertical'

export const ZcIconBorderVertical = withInstall(_comp, 'ZcIconBorderVertical')
