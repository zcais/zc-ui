 ...
 * Source: icons/outline/sparkles.svg
 */
...
registerIcon('sparkles', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconSparkles'

export const ZcIconSparkles = withInstall(_comp, 'ZcIconSparkles')
