 ...
 * Source: icons/outline/shield-dollar.svg
 */
...
registerIcon('shield-dollar', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconShieldDollar'

export const ZcIconShieldDollar = withInstall(_comp, 'ZcIconShieldDollar')
