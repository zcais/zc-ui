 ...
 * Source: icons/outline/chef-hat.svg
 */
...
registerIcon('chef-hat', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconChefHat'

export const ZcIconChefHat = withInstall(_comp, 'ZcIconChefHat')
