 ...
 * Source: icons/outline/lock-check.svg
 */
...
registerIcon('lock-check', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconLockCheck'

export const ZcIconLockCheck = withInstall(_comp, 'ZcIconLockCheck')
