 ...
 * Source: icons/outline/pointer-x.svg
 */
...
registerIcon('pointer-x', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconPointerX'

export const ZcIconPointerX = withInstall(_comp, 'ZcIconPointerX')
