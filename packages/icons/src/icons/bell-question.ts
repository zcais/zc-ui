 ...
 * Source: icons/outline/bell-question.svg
 */
...
registerIcon('bell-question', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconBellQuestion'

export const ZcIconBellQuestion = withInstall(_comp, 'ZcIconBellQuestion')
