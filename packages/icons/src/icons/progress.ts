 ...
 * Source: icons/outline/progress.svg
 */
...
registerIcon('progress', { path: _body, viewBox: '0 0 24 24', strokeWidth: 2, fill: 'none' })
...
_comp.displayName = 'ZcIconProgress'

export const ZcIconProgress = withInstall(_comp, 'ZcIconProgress')
