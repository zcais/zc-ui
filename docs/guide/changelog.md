...
- [GitHub Releases](https://github.com/zcais/zc-ui/releases)
- [CHANGELOG.md（仓库根目录）](https://github.com/zcais/zc-ui/blob/main/CHANGELOG.md)
...
1. 访问 [Releases 页面](https://github.com/zcais/zc-ui/releases) 查看每个版本的详细变更
...
::: tip
你可以通过查看 [`.changeset/` 目录](https://github.com/zcais/zc-ui/tree/main/.changeset) 了解未发布的变更。
:::
